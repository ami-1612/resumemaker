...
public class objective extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(objective.this);
        builder.setMessage("Do you want to exit back in workprofile page?");
        builder.setTitle("Alert !");
        builder.setCancelable(false);
        AlertDialog.Builder builder1 = builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(objective.this, "workprofile page ", Toast.LENGTH_SHORT).show();
            finish();
        });
        builder.setNegativeButton("No", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(objective.this, "No clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
        builder.setNeutralButton("cancle", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(objective.this, "Cancle clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
