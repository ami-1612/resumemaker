...
public class template extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Do you want to exit back in refrence page ?");
        builder.setTitle("Alert !");
        builder.setCancelable(false);
        AlertDialog.Builder builder1 = builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(template.this, "refrence page ", Toast.LENGTH_SHORT).show();
            finish();
        });
        builder.setNegativeButton("No", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(template.this, "No clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
        builder.setNeutralButton("cancle", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(template.this, "Cancle clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
