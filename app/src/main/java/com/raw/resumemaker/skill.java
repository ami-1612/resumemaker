...
public class skill extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(skill.this);
        builder.setMessage("Do you want to exit back in experiencce page?");
        builder.setTitle("Alert !");
        builder.setCancelable(false);
        AlertDialog.Builder builder1 = builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(skill.this, "experiencce page ", Toast.LENGTH_SHORT).show();
            finish();
        });
        builder.setNegativeButton("No", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(skill.this, "No clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
        builder.setNeutralButton("cancle", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(skill.this, "Cancle clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
