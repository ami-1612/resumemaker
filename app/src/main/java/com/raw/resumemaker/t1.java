...
public class t1 extends AppCompatActivity {
    ...
    TextView  tvaddress, tvemail, tvphon, tvcourse, tvschool, tvgrade, tvyear, tvcomapany, tvjob, tvdescription, tvjobyear, tvskill1, tvskill2, tvskill3, tvskill4, tvgithub, tvlinkdin, tvobjective, tvcomapanyname, tvcomapanylink;
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Do you want to exit back?");
        builder.setTitle("Alert !");
        builder.setCancelable(false);
        AlertDialog.Builder builder1 = builder.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(t1.this, "yes clicked", Toast.LENGTH_SHORT).show();
            finish();
        });
        builder.setNegativeButton("No", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(t1.this, "No clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
        builder.setNeutralButton("cancle", (DialogInterface.OnClickListener) (dialog, which) -> {
            Toast.makeText(t1.this, "Cancle clicked", Toast.LENGTH_SHORT).show();
            dialog.cancel();
        });
